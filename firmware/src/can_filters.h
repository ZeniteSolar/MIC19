...
const uint8_t can_filter[] PROGMEM =
{
    ...
    // Group 1
    MCP2515_FILTER(CAN_MSG_MIC19_MCS_ID),
    MCP2515_FILTER(CAN_MSG_MCS19_START_STAGES_ID),
    MCP2515_FILTER(CAN_MSG_MCV25_MOTOR_ID), // Filter 0
    // MCP2515_FILTER(CAN_MSG_MCV25_MDE_ID), // Filter 1
    MCP2515_FILTER(CAN_MSG_MCV25_BOAT_STATE_ID), // Filter 1
