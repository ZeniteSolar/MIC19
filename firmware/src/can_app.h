...
void can_app_send_autopilot_disable(void);
void can_app_extractor_mcs_relay(can_t *msg);
void can_app_extractor_mna_state(can_t *msg);
void can_app_extractor_mna_command(can_t *msg);
...
#ifdef CAN_ON
#define CAN_APP_SEND_STATE_CLK_DIV (MACHINE_TIMER_FREQUENCY / CAN_MSG_MIC19_STATE_FREQUENCY)
#define CAN_APP_SEND_MOTOR_CLK_DIV (MACHINE_TIMER_FREQUENCY / CAN_MSG_MIC19_MOTOR_FREQUENCY)
#define CAN_APP_SEND_MDE_CLK_DIV (MACHINE_TIMER_FREQUENCY / CAN_MSG_MIC19_MDE_FREQUENCY)
#define CAN_APP_SEND_BOAT_CLK_DIV (MACHINE_TIMER_FREQUENCY / CAN_MSG_MIC19_MCS_FREQUENCY)
#define CAN_APP_SEND_PUMPS_CLK_DIV (MACHINE_TIMER_FREQUENCY / CAN_MSG_MIC19_PUMPS_FREQUENCY)
#define CAN_APP_SEND_MNA_CLK_DIV (MACHINE_TIMER_FREQUENCY / CAN_MSG_MIC19_MNA_FREQUENCY)
#endif
...
extern uint32_t can_app_send_mna_div;
